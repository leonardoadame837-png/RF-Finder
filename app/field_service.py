...
class RFService:
    def __init__(self, config=default_config, source=None, scan_interval_s=0.5):
    ...
    @property
    def source_name(self): return source_provenance(self.source)["source"]
    @property
    def source_type(self): return normalize_source_type(source_provenance(self.source)["source_type"])
    def start(self):
        with self._lock:
